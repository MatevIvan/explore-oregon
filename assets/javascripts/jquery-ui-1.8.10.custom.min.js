  ...
  if (!c.ui.version) {
    ...
    c.fn.extend({
      ...
      disableSelection: function () {
        return this.bind(
          (c.support.selectstart ? "selectstart" : "mousedown") + ".ui-disableSelection",
          function (a) {
            a.preventDefault();
          }
        );
        ...
        var b = this,
          ...
          f =
            typeof this.options.cancel == "string"
              ? c(a.target).parents().add(a.target).filter(this.options.cancel).length
              : false;
...
(function (c) {
  c.widget("ui.accordion", {
    ...
    _create: function () {
      ...
      b.event &&
        a.headers.bind(b.event.split(" ").join(".accordion ") + ".accordion", function (f) {
    ...
    _setOption: function (a, b) {
      ...
      if (a == "disabled")
        this.headers
          ...
          [b ? "addClass" : "removeClass"]("ui-accordion-disabled ui-state-disabled");
    },
    _keydown: function (a) {
...
(function (d, p) {
  ...
  d.widget("ui.tabs", {
    ...
    _tabId: function (b) {
      return (
        (b.title && b.title.replace(/\s/g, "_").replace(/[^\w\u00c0-\uFFFF-]/g, "")) ||
    ...
    _tabify: function (b) {
      ...
      this.anchors.each(function (g, f) {
        ...
        if (
          l &&
          (l === location.toString().split("#")[0] || ((q = d("base")[0]) && l === q.href))
        ) {
          i = f.hash;
          f.href = i;
        }
      ...
      if (b) {
        ...
        c.selected =
          (c.selected >= 0 && this.anchors[c.selected]) || c.selected < 0 ? c.selected : 0;
        c.disabled = d
          .unique(
            c.disabled.concat(
          ...
          a.element.queue("tabs", function () {
            a._trigger(
              ...
              a._ui(
                ...
                a.element.find(a._sanitizeSelector(a.anchors[c.selected].hash))[0]
              )
            );
          });
...
(function (d, G) {
  ...
  d.extend(K.prototype, {
    ...
    _autoSize: function (a) {
      if (this._get(a, "autoSize") && !a.inline) {
        ...
        if (c.match(/[DM]/)) {
          ...
          b.setDate(
            e(this._get(a, c.match(/DD/) ? "dayNames" : "dayNamesShort")) + 20 - b.getDay()
          );
        }
    ...
    _doKeyDown: function (a) {
      ...
      if (d.datepicker._datepickerShowing)
        switch (a.keyCode) {
          ...
          case 13:
            c = d(
              "td." + d.datepicker._dayOverClass + ":not(." + d.datepicker._currentClass + ")",
              b.dpDiv
            );
            c[0]
              ? d.datepicker._selectDay(a.target, b.selectedMonth, b.selectedYear, c[0])
              : d.datepicker._hideDatepicker();
            return false;
          case 27:
            d.datepicker._hideDatepicker();
    ...
    _updateDatepicker: function (a) {
      ...
      e = c[1];
      e > 1
        ? a.dpDiv.addClass("ui-datepicker-multi-" + e).css("width", 17 * e + "em")
        : a.dpDiv
      ...
      if (!(!b || (a && b != d.data(a, "datepicker"))))
        if (this._datepickerShowing) {
          ...
          d.effects && d.effects[a]
            ...
            : b.dpDiv[a == "slideDown" ? "slideUp" : a == "fadeIn" ? "fadeOut" : "hide"](
                a ? c : null,
                e
              );
          a || e();
    ...
    W3C: "yy-mm-dd",
    _ticksTo1970:
      (718685 + Math.floor(492.5) - Math.floor(19.7) + Math.floor(4.925)) * 24 * 60 * 60 * 1e7,
      ...
      for (var L = this._getDefaultDate(a), I = "", C = 0; C < i[0]; C++) {
        for (var M = "", D = 0; D < i[1]; D++) {
          ...
          for (var O = 0; O < A; O++) {
            ...
            var P = !j
              ? ""
              : '<td class="ui-datepicker-week-col">' + this._get(a, "calculateWeek")(q) + "</td>";
            for (t = 0; t < 7; t++) {
              ...
              P +=
                ...
                ((q.getTime() == N.getTime() && g == a.selectedMonth && a._keyEvent) ||
  ...
  d.fn.datepicker = function (a) {
    ...
    return this.each(function () {
      typeof a == "string"
        ? d.datepicker["_" + a + "Datepicker"].apply(d.datepicker, [this].concat(b))
  ...
  (function (f, j) {
    ...
    f.each(
      ...
      function (c, a) {
        f.fx.step[a] = function (b) {
          ...
          b.elem.style[a] =
            "rgb(" +
            Math.max(Math.min(parseInt(b.pos * (b.end[0] - b.start[0]) + b.start[0], 10), 255), 0) +
            "," +
    ...
    f.fn.extend({
      ...
      toggleClass: function (c, a, b, d, e) {
        return typeof a == "boolean" || a === j
          ? b
            ? f.effects.animateClass.apply(this, [a ? { add: c } : { remove: c }, b, d, e])
    ...
    f.extend(f.easing, {
      ...
      easeInOutElastic: function (c, a, b, d, e) {
        ...
        if (a < 1)
          return (
            -0.5 * h * Math.pow(2, 10 * (a -= 1)) * Math.sin(((a * e - c) * 2 * Math.PI) / g) + b
          );
        return (
          h * Math.pow(2, -10 * (a -= 1)) * Math.sin(((a * e - c) * 2 * Math.PI) / g) * 0.5 + d + b
        );
      },
...
(function (e) {
  e.effects.bounce = function (b) {
    return this.queue(function () {
      ...
      c =
        b.options.distance ||
        (f == "top" ? a.outerHeight({ margin: true }) / 3 : a.outerWidth({ margin: true }) / 3);
...
(function (c) {
  c.effects.drop = function (d) {
    return this.queue(function () {
      ...
      var g =
        d.options.distance ||
        (f == "top" ? a.outerHeight({ margin: true }) / 2 : a.outerWidth({ margin: true }) / 2);
...
(function (j) {
  j.effects.explode = function (a) {
    return this.queue(function () {
      ...
      a.options.mode =
        a.options.mode == "toggle" ? (j(this).is(":visible") ? "hide" : "show") : a.options.mode;
          ...
          b.clone()
            ...
            .css({
              ...
              left:
                g.left +
                f * (h / d) +
                (a.options.mode == "show" ? (f - Math.floor(d / 2)) * (h / d) : 0),
              top:
                g.top +
                e * (i / c) +
                (a.options.mode == "show" ? (e - Math.floor(c / 2)) * (i / c) : 0),
            ...
            .animate(
              {
                left:
                  g.left +
                  f * (h / d) +
                  (a.options.mode == "show" ? 0 : (f - Math.floor(d / 2)) * (h / d)),
                top:
                  g.top +
                  e * (i / c) +
...
(function (c) {
  c.effects.slide = function (d) {
    return this.queue(function () {
      ...
      var e =
        d.options.distance ||
        (g == "top" ? a.outerHeight({ margin: true }) : a.outerWidth({ margin: true }));
